using Soft.Persistance.DAOImpl.Util;
using Soft.Db;
using System;
...
namespace Soft.Persistance.DAOImpl
{
    public abstract class DAOImplBase
    {
        ...
        {
            this.nombreDeTabla = nombreDeTabla; // Eliminable, constructor no recibe nombre de tabla si no es necesario
            this.retornarLlavePrimaria = false;
            this.mostrarSentenciaSQL = true;
            this.usarTransaccion = true;
            this.IncluirListaDeColumnas(); // Eliminable
        }
        ...
        // ELIMINABLE si no se usan llaves primarias auto generadas
        ...
        // A partir de aquí, si se proveen stored procedures, eliminar el contenido de los métodos, eliminar todo lo relacionado a clase columna y para cada método, hacer
        // override para que llame al stored procedure correspondiente con "CALL NOMBRE_DEL_PROCEDIMIENTO(?,?)" y agregar los parámetros necesarios.

        protected virtual string GenerarSQLParaInsercion()
        {
        ...
        protected virtual string GenerarSQLParaModificacion()
        {
            //sentencia SQL a generar es similar a 
        ...
        protected virtual string GenerarSQLParaEliminacion()
        {
            //sentencia SQL a generar es similar a 
        ...
        protected virtual string GenerarSQLParaObtenerPorId()
        {
            //sentencia SQL a generar es similar a 
        ...
        protected virtual string GenerarSQLParaListarTodos()
        {
            //sentencia SQL a generar es similar a 
