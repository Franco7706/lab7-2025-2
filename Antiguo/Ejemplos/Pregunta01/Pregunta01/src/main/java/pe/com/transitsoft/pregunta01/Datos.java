...
import pe.com.transitsoft.model.Gravedad;
import pe.com.transitsoft.model.Infraccion;
import pe.com.transitsoft.model.RegistroInfraccion;
import pe.com.transitsoft.model.TipoLicencia;
import pe.com.transitsoft.model.Vehiculo;
...
public class Datos {
    ...
    public static void cargarDatos(
        ...
        try {
            ...
            vehiculosConductor.add(vc1);
            vehiculosConductor.add(vc2);
            vehiculosConductor.add(vc3);
            vehiculosConductor.add(vc4);
            vehiculosConductor.add(vc5);
            vehiculosConductor.add(vc6);
            vehiculosConductor.add(vc7);
            vehiculosConductor.add(vc8);
            vehiculosConductor.add(vc9);
            vehiculosConductor.add(vc10);
            vehiculosConductor.add(vc11);
            vehiculosConductor.add(vc12);
            vehiculosConductor.add(vc13);
            vehiculosConductor.add(vc14);
        }
        ...
        try {
            ...
            registrosInfracciones.add(ri1);
            registrosInfracciones.add(ri2);
            registrosInfracciones.add(ri3);
            registrosInfracciones.add(ri4);
            registrosInfracciones.add(ri5);
            registrosInfracciones.add(ri6);
            registrosInfracciones.add(ri7);
