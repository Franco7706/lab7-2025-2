...
public class VehiculoDAOImpl extends DAOImplBase implements VehiculoDAO {
    ...
    public ArrayList<VehiculoDTO> listarPorPropietario(String descripion_propietario) {
        ...
        ArrayList<VehiculoDTO> listadoMSSQL = (ArrayList<VehiculoDTO>) super.listarTodos(MotorDeBaseDeDatos.MSSQL, sql, this::incluirValorDeParametrosParaListarPorPropietario, descripion_propietario);
        listado.addAll(listadoMSSQL);
        return listado;
    }
