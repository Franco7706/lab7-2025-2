...
namespace TransitSoft.Db
{
    public class DBManagerMySQL: DBManager
    {
        ...
        {
            this.baseDeDatos = ConfigurationManager.AppSettings["baseDeDatosMySQL"];
            this.nombreDeHost = ConfigurationManager.AppSettings["nombreDeHostMySQL"];
            this.puerto = ConfigurationManager.AppSettings["puertoMySQL"];
            this.usuario = ConfigurationManager.AppSettings["usuarioMySQL"];
