...
public class VehiculoBO {
    ...
    public VehiculoDTO insertarOModificar(VehiculoDTO vehiculoDTO) throws JsonProcessingException, IOException, InterruptedException{        
        this.crearHttpClient();
        this.crearHttpRequestPOST(serializarDTO(vehiculoDTO),"application/json",this.url);
        this.enviarRequest();
