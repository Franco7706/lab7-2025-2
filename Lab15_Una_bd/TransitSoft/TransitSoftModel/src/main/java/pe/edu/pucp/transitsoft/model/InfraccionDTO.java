...
public class InfraccionDTO {
    ...
    public InfraccionDTO(Integer id, String placa, Double velocidad, Double limite, Double exceso, String marcaVehiculo, String modeloVehiculo, Integer anhoVehiculo, String dniPropietario, String nombresPropietario, String apellidosPropietario, String direccionPropietario, Integer idCamara, String modeloCamara, String codigoSerieCamara, Long latitud, Long longitud, Double monto, Date fechaCaptura, Date fechaRegistro) {
        this.id = id;
        this.placa = placa;
